...
class Ui_MainWindow(QObject):
    def setupUi(self, MainWindow):
        ...
        self.gif_lbl = QtWidgets.QLabel(self.page_10)
        self.gif_lbl.setGeometry(QtCore.QRect(350, 590, 201, 51))
        self.gif_lbl.setText("")
        self.gif_lbl.setPixmap(QtGui.QPixmap("loading.gif"))
        self.gif_lbl.setObjectName("gif_lbl")
